...
#cm_score_file = 'pa_spec_cmn_eval/18-dev_scores.txt'

#cm_score_file = 'tasks_scores/18-dev_scores.txt'
cm_score_file = 'tasks_scores/30-dev_scores.txt' # 'tasks_scores/30-scores.txt'
...
eer_cm, thresh = em.compute_eer(bona_cm, spoof_cm)

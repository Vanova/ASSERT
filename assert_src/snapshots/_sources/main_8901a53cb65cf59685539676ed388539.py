...
def my_config():
    ...
    data_files = {  # training
        ...
        'dev_scp': '/home/vano/wrkdir/projects/antispoofing_speech/kaldi_feats/data/ASVspoof2019_LA_eval_spec/feats.scp',
        'dev_utt2index': 'data_reader/utt2systemID/la_eval_utt2index_8',
        'dev_utt2systemID': 'data_reader/utt2systemID/la_eval_utt2systemID',
        'eval_utt2systemID': 'data_reader/utt2systemID/la_eval_utt2systemID',
        'scoring_dir': 'scoring/la_cm_scores_eval/',
    }
    ...
    pretrained_model_id = 20  # for forward pass

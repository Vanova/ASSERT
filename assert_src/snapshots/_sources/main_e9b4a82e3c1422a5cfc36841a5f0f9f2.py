"""
NOTE: checkpoints can be loaded by python2 and pytorch 0.4.0
"""
import numpy as np
import os
import random
...
def my_config():
    ...
    data_files = {  # training
        ...
        # 'dev_utt2index': 'data_reader/utt2systemID/pa_eval_utt2index_8',
        # 'dev_utt2systemID': 'data_reader/utt2systemID/pa_eval_utt2systemID',
        'dev_scp': '/home/vano/wrkdir/projects/antispoofing_speech/kaldi_feats/data/test_audio_spec/feats.scp',
        'dev_utt2index': 'data_reader/utt2systemID/test_audio_utt2index_8',
        'dev_utt2systemID': 'data_reader/utt2systemID/test_audio_utt2systemID',
        'eval_utt2systemID': 'data_reader/utt2systemID/pa_eval_utt2systemID',
        'scoring_dir': 'scoring/test_audio_scores/',
    }
    ...
    pretrained_model_id = -1# 18 # LA 20  # for forward pass
